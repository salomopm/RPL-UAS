        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="administrator.php">
                    <i class="fas fa-home"><span>Beranda</span></i>
                </a>
            </li><!-- End Beranda Nav -->
                        ...
                        <table border="1" cellpadding="10" cellspacing="0" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <?php foreach ($db_informasi as $row) : ?>
                                    <td><?= $i; ?></td>
                                    <td>
                                        <a href="coba-ubah-informasi.php?id=<?= $row["id"]; ?>">Ubah</a>
                                        <a href="coba-hapus-info.php?id=<?= $row["id"]; ?>" onclick="return confirm('Apakah data akan dihapus?');">Hapus</a>
                                    </td>
                                    <td><?= $row["deskripsi"] ?></td>
                                    <td>
