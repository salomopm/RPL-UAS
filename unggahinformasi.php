        ...
        <div class="side-navbar">
            ...
            <nav class="navbar bg-body-tertiary">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
                    ...
                    <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3  a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
                </svg>
                    <a class="nav-link active" aria-current="page" href="logout.php">Log Out</a>
                </div>
            </nav>
        </div>
        <div class="isi-tengah-unggahinfo">
