...
$db_informasi = query("SELECT * FROM db_informasi WHERE id=$id")[0];
...
if (isset($_POST["submit"])) {
    if (ubahInfo($_POST) > 0) {
        echo "<script>
        alert('Ubah Informasi Berhasil')
        </script>";
        header('Location: /coba-man-info.php');
    } else {
        echo "<script>
        alert('Ubah Informasi Gagal')
        </script>";
    }
}
...
<head>
    ...
    <title>kelola-informasi-uns-sharing</title>
        ...
        <section class="section dashboard">
            <div class="col-12">
                <div class="card recent-sales overflow-auto">
                    <div class="card-body">
                        <h2 class="card-title" style="text-align: justify;">Kelola Informasi</h2>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="5" cols="60" name="yourDeskripsi" class="form-control" id="yourDeskripsi" placeholder="Enter text" value="<?= $db_informasi["deskripsi"] ?>"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="yourGambar" class="form-label">Gambar</label>

                                <input id="yourGambar" class="form-control" type="file" name="yourGambar" />
                                <script>
                                    document.getElementById("yourGambar").value = "<?php echo $db_informasi["yourGambar"]; ?>";
                                </script>
                            </div>
                            <div class="mb-3">

                                <label for="yourProdi" class="form-label">Fakultas</label>
                                ...
                                <select class="form-select" aria-label="Default select example" name="yourProdi" id="yourProdi">
                                    ...
                                    <option value="<?= $db_informasi["prodi"] = "Sains Data" ?>">Sains Data</option>
                                </select>
                            ...
                            <div class="mb-3 waktu-ubah">
                                ...
                                <script>
                                    document.getElementById("yourWaktu").value = "<?php echo $db_informasi["yourWaktu"]; ?>";
                                </script>
                            </div>
