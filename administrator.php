    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Unggah Informasi Prodi</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="#">Informasi Prodi</a>
                    </li>
            ...
            <div class="row1">
                ...
                <div class="card2">
                    <div class="card" style="width: 25rem; height: 10rem;">
                        ...
                        <div class="card-body">
                            <p class="total-user-text">Prodi</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card3">
                <div class="card" style="width: 25rem; height: 10rem;">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <p class="total-user-text">Total Fakultas</p>
                    </div>
                </div>
            </div>
        </div>
